        ...
        add_dialog_musicform.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectList.size() == 0) {
                    ...
                    songListBiz.insert(FromMusicActivity.this, new SongList(songListName, songName, userName));
                } else {
    ...
    public void deleteDialog() {
        ...
        builder.setPositiveButton("确定", new Dialog.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (selectList.size() == 0) {
                    songListBiz.deleteSong(FromMusicActivity.this, songListName, song.get("songName").toString(), userName);
                } else {
                    for (int index : selectList) {
                        songListBiz.deleteSong(FromMusicActivity.this, songListName, listItems.get(index).get("songName").toString(), userName);
                    }
                }
                selectList.clear();
                listItems = init();
