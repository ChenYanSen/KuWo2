            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.music_expend_add:
                        Toast.makeText(LikeMusicActivity.this, "添加", Toast.LENGTH_SHORT).show();
                        break;

                    case R.id.music_expend_info:
                        Toast.makeText(LikeMusicActivity.this, "信息", Toast.LENGTH_SHORT).show();
                        break;

                    case R.id.music_expend_delete:
                        Toast.makeText(LikeMusicActivity.this, "删除", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        }
