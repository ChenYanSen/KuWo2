...
public interface SongListDao {
    ...
    public abstract void deleteSong(final SQLiteDatabase sqLiteDatabase, final String songListName, final String songName, final String userName) throws SQLException;
}
